...
namespace {
    ...
    add_action(
        ...
        static function (): void {
            ...
            // Keep Elementor One's sidebar navigation, but start it collapsed for
            // users who have not chosen a sidebar state yet. Elementor owns this
            // localStorage key and continues to persist later user changes.
            add_action(
                'admin_enqueue_scripts',
                static function (): void {
                    wp_add_inline_script(
                        'editor-one-sidebar-navigation',
                        "try{if(null===localStorage.getItem('elementor_sidebar_collapsed')){localStorage.setItem('elementor_sidebar_collapsed','true');}}catch(e){}",
                        'before'
                    );
                },
                PHP_INT_MAX
            ...
            echo '<style id="elementor-quiet-mode-ai">'
                . implode(
                    ...
                    [
                        ...
                        '#editor-one-sidebar-navigation nav > hr:last-of-type + div',
